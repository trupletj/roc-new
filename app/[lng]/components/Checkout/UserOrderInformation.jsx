          ...
          <div className="md:col-span-3 col-span-1">
            ...
            <div className="mt-2">
              <input
                disabled={true}
                placeholder={t("phone")}
                {...register("phone", { required: false, maxLength: 8 })}
                type="text"
                name="phone"
                id="phone"
                className="block w-full  border border-[#707070]  py-1.5 text-gray-900 placeholder:text-gray-400 sm:text-sm px-3 bg-white"
            ...
            <>
              <div className="sm:col-span-3">
                ...
                <div className="mt-2">
                  <input
                    ...
                    value={currentAddress.receiver_name}
                    type="text"
                    name="receiver_name"
                    id="receiver_name"
                    className="block w-full px-3  border border-[#707070]  py-1.5 text-gray-900 placeholder:text-gray-400 sm:text-sm bg-gray-400"
                  />
                </div>
              </div>
              <div className="sm:col-span-3">
                ...
                <div className="mt-2">
                  <input
                    ...
                    value={currentAddress.receiver_phone}
                    type="text"
                    name="receiver_phone"
                    id="receiver_phone"
                    className="block w-full  px-3 border border-[#707070]  py-1.5 text-gray-900 placeholder:text-gray-400 sm:text-sm bg-gray-400"
              ...
              <div className="sm:col-span-6">
                ...
                <div className="mt-2">
                  <select
                    ...
                    type="select"
                    className="block w-full  border border-[#707070] px-2  py-1.5 text-gray-900 placeholder:text-gray-400 sm:text-sm bg-gray-400"
                  >
              ...
              <div className="sm:col-span-6">
                ...
                <div className="mt-2">
                  <textarea
                    disabled
                    value={currentAddress.address_information}
                    rows={4}
                    type="text"
